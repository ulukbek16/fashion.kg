    ...
    <section id="middle" class="grey_section">
        <div class="container">
            <div class="row">
                ...
                <a href="index.php" style="color:#fff;"><h2 style="background: blue;width: 500px;float: right;height: 50px;padding: 5px;border:3px solid #000;border-radius: 5px;color:#fff;">Посмотреть список одежд</h2></a>
                 
                
                    <h2 class="block-header">Добавить Одежду</h2>
  ...
  <tr>
      <td style="text-align: center;margin-left: -200px;">
        <form name="tour" method="post" action="" style="margin-left: 399px;">
           <label>Название одежды:</label><br><input type="text" name="title"><br>
